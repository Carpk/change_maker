...
describe "ScreenUtility" do
  ...
  describe "should prompt user" do
    ...
    it "for currency" do
      ...
      expect { console.prompt_for_currency }.to output(prompt).to_stdout
    end

    it "for breaking amount" do
      prompt = "How much would you like to break?\n"
      expect { console.prompt_for_amount }.to output(prompt).to_stdout
    end
  end

  it "should return correct value" do
    prompt = "You will recieve back: 14\n"
    expect { console.display_change(14) }.to output(prompt).to_stdout
  end

  it "should return correct value" do
    prompt = "You will recieve back: 8\n"
    expect { console.display_change(8) }.to output(prompt).to_stdout
  end

  it "should return correct value" do
    prompt = "You will recieve back: 304\n"
    expect { console.display_change(304) }.to output(prompt).to_stdout
  end
end